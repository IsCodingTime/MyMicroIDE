...
package com.mucheng.annotations.mark.exceptions

import com.mucheng.annotations.mark.Inheritable

/**
 * 此异常类表明调用了不受支持的方法
 *
 * @param methodName 不受支持的方法名
 * */
@Inheritable
open class UnsupportedMethodCalledException(methodName: String) : IllegalAccessException(
    """
    Unsupported method `$methodName` is called.
""".trimIndent()
)